...
//             'a[href*="youtu"], a[href*="youtube.com/watch"], a[href*="/shorts/"], a[href*="/watch?v="]'
//         );
...
//                 const container =
//                     a.closest(
//                         "yt-lockup-view-model, .yt-lockup-view-model, yt-lockup-metadata-view-model, .yt-lockup-metadata-view-model, ytd-rich-item-renderer, ytd-compact-video-renderer, ytd-video-renderer"
//                     ) || a;
//                 const img = container.querySelector("img") || a.querySelector("img");
//                 const title = extractCleanTitle(container) || extractCleanTitle(a);
//                 const thumb =
//                     img && (img.getAttribute("src") || img.getAttribute("data-thumb") || img.getAttribute("data-src"));
//                 if (title || thumb) {
...
//         return null;
//     } catch (e) {
//         console.warn("[ShareTube] findOnPageYouTubeMeta failed", e);
//         return null;
//     }
// }
...
//     } catch (e) {
//         try {
//             console.debug("[ShareTube] toAbsoluteUrl failed", e);
//         } catch (_) {}
//         return null;
//     }
// }
...
//     } catch (e) {
//         try {
//             console.debug("[ShareTube] extractVideoId failed", e);
//         } catch (_) {}
//         return "";
//     }
// }
...
//         }
//     }
//     const lockupTitle = root.querySelector(
//         ".yt-lockup-metadata-view-model__title, h3 .yt-lockup-metadata-view-model__title, h3 a.yt-lockup-metadata-view-model__title"
//     );
//     if (lockupTitle) {
...
//     } catch (e) {
//         try {
//             console.debug("[ShareTube] fetchMetadataFromBackend failed", e);
//         } catch (_) {}
//         return null;
//     }
// }
