...
This project uses a **Commercial License** that allows free personal/non-commercial use but requires licensing for commercial applications.
...
See the [LICENSE](LICENSE) file for complete terms and conditions, and [COMMERCIAL_LICENSE.md](COMMERCIAL_LICENSE.md) for licensing options.
